 ...
 */
export function powerPathLessonPlansDeleteLessonPlanItem(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteLessonPlanItemRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/powerpath/lessonPlans/items/{lessonPlanItemId}")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "deleteLessonPlanItem",
    oAuth2Scopes: [],
