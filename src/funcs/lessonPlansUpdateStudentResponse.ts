 ...
 */
export function lessonPlansUpdateStudentResponse(
  client: PowerPathCore,
  request?: operations.UpdateStudentItemResponseRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateStudentItemResponseResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateStudentItemResponseRequest$outboundSchema.optional()
        .parse(value),
  ...
  const path = pathToFunc("/powerpath/lessonPlans/updateStudentItemResponse")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, operations.UpdateStudentItemResponseResponse$inboundSchema),
