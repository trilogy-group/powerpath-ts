 ...
 */
export function powerPathLessonPlansDeleteLessonPlan(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteLessonPlanRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/powerpath/lessonPlans/{lessonPlanId}")(pathParams);
