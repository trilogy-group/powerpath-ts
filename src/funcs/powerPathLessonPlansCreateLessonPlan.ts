 ...
 */
export function powerPathLessonPlansCreateLessonPlan(
  client: PowerPathCore,
  request?: operations.CreateLessonPlanRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateLessonPlanResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateLessonPlanRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/powerpath/lessonPlans/")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateLessonPlanResponse$inboundSchema),
    M.json(201, operations.CreateLessonPlanResponse$inboundSchema),
