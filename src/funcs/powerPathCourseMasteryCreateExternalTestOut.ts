 ...
 */
export function powerPathCourseMasteryCreateExternalTestOut(
  client: PowerPathCore,
  request?: operations.CreateExternalTestOutRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateExternalTestOutResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateExternalTestOutRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const path = pathToFunc("/powerpath/createExternalTestOut")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateExternalTestOutResponse$inboundSchema),
