...
export function lessonsResetAttempt(
  ...
  Result<
    operations.ResetAttemptResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ResetAttemptRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/powerpath/resetAttempt")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ResetAttemptResponse$inboundSchema),
