 ...
 */
export function lessonsFinalizeResponse(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.FinalStudentAssessmentResponseRequest$outboundSchema.optional()
        .parse(value),
  ...
  const path = pathToFunc("/powerpath/finalStudentAssessmentResponse")();
