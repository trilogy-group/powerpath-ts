 ...
 */
export function powerPathLessonPlansUpdateLessonPlanItem(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateLessonPlanItemRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "updateLessonPlanItem",
    oAuth2Scopes: [],
