 ...
 */
export function powerPathPlacementGetAllPlacementTests(
  client: PowerPathCore,
  request: operations.GetAllPlacementTestsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetAllPlacementTestsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAllPlacementTestsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/powerpath/placement/getAllPlacementTests")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAllPlacementTestsResponse$inboundSchema),
