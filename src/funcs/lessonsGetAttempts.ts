...
export function lessonsGetAttempts(
  ...
  Result<
    operations.GetAttemptsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAttemptsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/powerpath/getAttempts")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAttemptsResponse$inboundSchema),
