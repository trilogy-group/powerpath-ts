 ...
 */
export function lessonPlansGetStudentCourseProgress(
  client: PowerPathCore,
  request: operations.GetCourseProgressRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetCourseProgressResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetCourseProgressRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    studentId: encodeSimple("studentId", payload.studentId, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetCourseProgressResponse$inboundSchema),
