...
export function lessonsGetNextQuestion(
  ...
  Result<
    operations.GetNextQuestionResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetNextQuestionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/powerpath/getNextQuestion")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetNextQuestionResponse$inboundSchema),
