 ...
 */
export function powerPathCourseMasteryMakeExternalTestAssignment(
  client: PowerPathCore,
  request?: operations.MakeExternalTestAssignmentRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.MakeExternalTestAssignmentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.MakeExternalTestAssignmentRequest$outboundSchema.optional()
        .parse(value),
  ...
  const path = pathToFunc("/powerpath/makeExternalTestAssignment")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MakeExternalTestAssignmentResponse$inboundSchema),
