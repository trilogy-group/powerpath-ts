 ...
 */
export function powerPathPlacementGetSubjectProgress(
  client: PowerPathCore,
  request: operations.GetSubjectProgressRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetSubjectProgressResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetSubjectProgressRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/powerpath/placement/getSubjectProgress")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetSubjectProgressResponse$inboundSchema),
