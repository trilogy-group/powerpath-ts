...
export type GetAssessmentProgressResponse =
  ...
  | (ResponseBody & { lessonType: "quiz" })
  | (ResponseBody & { lessonType: "test-out" })
  | (ResponseBody & { lessonType: "placement" });
...
> = z.union([
  ...
  z.lazy(() => ResponseBody$inboundSchema).and(
    z.object({ lessonType: z.literal("quiz") }),
  ),
  z.lazy(() => ResponseBody$inboundSchema).and(
    z.object({ lessonType: z.literal("test-out") }),
  ),
  z.lazy(() => ResponseBody$inboundSchema).and(
    z.object({ lessonType: z.literal("placement") }),
  ),
]);
/** @internal */
export type GetAssessmentProgressResponse$Outbound =
  | components.PowerPath100ProgressResult$Outbound
  | (ResponseBody$Outbound & { lessonType: "quiz" })
  | (ResponseBody$Outbound & { lessonType: "test-out" })
  | (ResponseBody$Outbound & { lessonType: "placement" });
...
> = z.union([
  ...
  z.lazy(() => ResponseBody$outboundSchema).and(
    z.object({ lessonType: z.literal("quiz") }),
  ),
  z.lazy(() => ResponseBody$outboundSchema).and(
    z.object({ lessonType: z.literal("test-out") }),
